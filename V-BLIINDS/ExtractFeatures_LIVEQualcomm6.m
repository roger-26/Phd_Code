...
% /media/javeriana/HDD_4TB/datasets/LIVE_QUALCOMM/color2
cd '/media/javeriana/HDD_4TB/datasets/LIVE_QUALCOMM/color/'
...
for video_set=1:size(Videos_Inside_Folder,1)
    ...
    save('stabilization_featuresVBLIINDS_LiveQualcomm.mat','features_test');
    save('stabilization_VideosProccessedLiveQualcomm.mat','Videos_Processed');
    toc;
end