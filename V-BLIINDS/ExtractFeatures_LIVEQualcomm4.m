...
cd '/media/javeriana/HDD_4TB/datasets/LIVE-Qualcomm/Sharpness/'
...
for video_set=1:size(Videos_Inside_Folder,1)
    ...
    save('Sharpness_featuresVBLIINDS_LiveQualcomm.mat','features_test');
    save('Sharpness_VideosProccessedLiveQualcomm.mat','Videos_Processed');
    toc;
end