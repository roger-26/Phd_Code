...
%   patches que se calculan, inicialmente de un size de 40x40, para que
%   sean cuadrados. Del PCA se toman los coeficientes 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
folder_created_Modified_frames = 'OriginalGrayscale_TLVQM_Normalized.m';
