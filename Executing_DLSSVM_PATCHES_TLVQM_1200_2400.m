    ...
    if mod(i,10)==0
        ...
        if i ~= 2030 && 3080
            ...
            if done==0
                ...
                results_TLVQM = ...
                    tracker_TLVQM_Features_CropDivided([video_path '\img'],image_type,disp_vd,init_rect,1,size_GT,prep);
                %                 end_frame = size(results.res,1);%frames en los que se pudo calcular el resultado
...
save('C:\Dropbox\Javeriana\current_work\tracker_prediction\results_DLSSVM_TLVQM_PATCHES_2901_3200.mat','results_ADVSD')
t_total = toc(tStart)
profile viewer