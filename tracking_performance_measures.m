function [distance_precision, average_center_location_error,overlaps] = ...
    tracking_performance_measures(positions, ground_truth, distance_precision_threshold)

%Esta FUNCIÓN ES MODIFICADA POR ROGER GOMEZ
...
%este es el que se debe usar para el failure rate
