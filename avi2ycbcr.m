function [successful_conversion]=avi2ycbcr(Name_Video,path2folder)
% This code converts a RGB video in AVI format to YCbCr (Mean Substracted Contrast Normalization
% Format)
