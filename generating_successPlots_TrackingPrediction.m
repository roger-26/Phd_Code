...
GT = load('0324Fo_IndWL_LQ_C3_gt.txt');

DLSSV_Reuslts = load('0324Fo_IndWL_LQ_C3_DLSSVM.mat');
FRIQUEE_Tracking_Results = load ('0324Fo_IndWL_LQ_C3_FRIQUEE560_Normalized.mat');
%%
...
grid minor
legend('DLSSVM','DLSSVM with 560 z-score normalized FRIQUEE features');
