...
Folder_Containing_Videos = ...
    '/media/javeriana/VISION_2/datasets/LIVE-Qualcomm/stabilization/'; 
cd '/media/javeriana/VISION_2/datasets/LIVE-Qualcomm/stabilization/'
%Fetching all names from AVI files in folder
Videos_Inside_Folder = dir('*.avi');
cd '/media/javeriana/VISION_EXT/Datasets/LIVE-Qualcomm_ycbcr/stabilization/'
