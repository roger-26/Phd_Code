...
load('C:\Dropbox\Javeriana\current_work\tracker_prediction\results_ADVSD_DLSSVM_TLVQMVariations_2251_2500.mat');
...
if i <=size(results_ADVSD,2)
    ...
    if done==0
        ...
        save('C:\Dropbox\Javeriana\current_work\tracker_prediction\results_ADVSD_DLSSVM_TLVQMVariations_2251_2500.mat','results_ADVSD')
