...
for i=1:Number_Videos
    aux1=qualcommVideoData.vidNames(i); %get the name of video
    aux3=char(aux1); %
...
%                 variable_containing_data = au
                ...
                for i1=1:rows
                    ...
                    MOS_fc6(Consecutivo_Video_Save)=MOS_Unbiased(i);
...
save('fc6_UniqueScene_Allvideos_54','data')
save('MOS_fc6_UniqueScene_Allvideos_54','MOS_fc6')
