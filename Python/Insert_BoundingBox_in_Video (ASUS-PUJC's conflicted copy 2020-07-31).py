...
os.chdir(r'C:\Dropbox\Javeriana\current_work\tracker_prediction\Test_Videos_Tracking\0298Exp_IndWL_LQ_C1')

#video pristine
# cap = cv2.VideoCapture('video1_blur_high.mp4')
cap = cv2.VideoCapture('0298Exp_IndWL_LQ_C1.mp4')
...
GT_Gaussian = data = np.loadtxt("0298Exp_IndWL_LQ_C1_gt.txt", delimiter=",", dtype="int");
gt = GT_Gaussian
#Tracker 1
tracker1_mat = sio.loadmat('0298Exp_IndWL_LQ_C1_DLSSVM.mat')
...
if number_of_trackers >1:
    tracker2_mat = sio.loadmat('0298Exp_IndWL_LQ_C1_DLSSVM_FRIQUEE560.mat')
